      ...
      <div className="Main_div">
        <div className="container">
          ...
          <div className=" mt-5 logoMaindiv2 pb-2 d-flex justify-content-center align-items-center">
            ...
            <a href="https://t.me/RiotRewards"><i className="fab fs-3 marginLeft fa-telegram-plane"></i></a>
            <a href="https://twitter.com/riotrewardsbsc?s=21"><i className="fab fs-3 marginLeft fa-twitter"></i></a>
          </div>
        </div>
